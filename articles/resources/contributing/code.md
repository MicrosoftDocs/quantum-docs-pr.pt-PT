...
<span data-ttu-id="a0be1-112">As :::no-loc(Q#)::: funções, operações e tipos definidos pelo utilizador que compõem bibliotecas como o cânone são automaticamente testados como parte do desenvolvimento no repositório [**Microsoft/QuantumLibraries.**](https://github.com/Microsoft/QuantumLibraries/)</span><span class="sxs-lookup"><span data-stu-id="a0be1-112">The :::no-loc(Q#)::: functions, operations, and user-defined types that make up libraries such as the canon are automatically tested as a part of development on the [**Microsoft/QuantumLibraries**](https://github.com/Microsoft/QuantumLibraries/) repository.</span></span>
...
<span data-ttu-id="a0be1-114">Com a versão mais :::no-loc(Q#)::: recente, os testes unitários são definidos usando o `@Test("QuantumSimulator")` atributo.</span><span class="sxs-lookup"><span data-stu-id="a0be1-114">With the latest :::no-loc(Q#)::: version, unit tests are defined using the `@Test("QuantumSimulator")` attribute.</span></span> <span data-ttu-id="a0be1-115">O argumento pode ser "QuantumSimulator", "ToffoliSimulator", "TraceSimulator", ou qualquer nome totalmente qualificado especificando o alvo de execução.</span><span class="sxs-lookup"><span data-stu-id="a0be1-115">The argument may be either "QuantumSimulator", "ToffoliSimulator", "TraceSimulator", or any fully qualified name specifying the run target.</span></span> <span data-ttu-id="a0be1-116">Vários atributos que definem diferentes alvos de execução podem ser ligados à mesma chamada.</span><span class="sxs-lookup"><span data-stu-id="a0be1-116">Several attributes defining different run targets may be attached to the same callable.</span></span> <span data-ttu-id="a0be1-117">Alguns dos nossos testes ainda usam o pacote deprecado [Microsoft.Quantum.Xunit](https://www.nuget.org/packages/Microsoft.Quantum.Xunit/) que expõe todas as :::no-loc(Q#)::: funções e operações que terminam no `Test` quadro [xUnit.](https://xunit.github.io/)</span><span class="sxs-lookup"><span data-stu-id="a0be1-117">Some of our tests still use the deprecated [Microsoft.Quantum.Xunit](https://www.nuget.org/packages/Microsoft.Quantum.Xunit/) package that exposes all :::no-loc(Q#)::: functions and operations ending in `Test` to the [xUnit](https://xunit.github.io/) framework.</span></span> <span data-ttu-id="a0be1-118">Este pacote já não é necessário para definir os testes unitários.</span><span class="sxs-lookup"><span data-stu-id="a0be1-118">This package is no longer needed for defining unit tests.</span></span> 
...
<span data-ttu-id="a0be1-141">Também pediremos alterações a um pedido de puxar se necessitar de mais documentação ou testes de unidade para nos ajudar a utilizá-lo, ou se diferir o suficiente em estilo do resto das :::no-loc(Q#)::: bibliotecas que irá dificultar aos utilizadores encontrar a sua funcionalidade.</span><span class="sxs-lookup"><span data-stu-id="a0be1-141">We'll also ask for changes to a pull request if it requires more documentation or unit tests to help us make use of it, or if it differs enough in style from the rest of the :::no-loc(Q#)::: libraries that it will make it harder for users to find your feature.</span></span>
...
<span data-ttu-id="a0be1-148">Para saber mais, continue com o seguinte guia sobre :::no-loc(Q#)::: estilo.</span><span class="sxs-lookup"><span data-stu-id="a0be1-148">To learn more, please continue with the following guide on :::no-loc(Q#)::: style.</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="a0be1-149">Saiba mais :::no-loc(Q#)::: sobre diretrizes de estilo</span><span class="sxs-lookup"><span data-stu-id="a0be1-149">Learn about :::no-loc(Q#)::: style guidelines</span></span>](xref:microsoft.quantum.contributing.style)
