...
---
# <a name="how-to-learn-about-quantum-computing"></a>Como posso saber mais sobre computação quântica?
...
A [Introdução ao Microsoft Quantum Development Kit](xref:microsoft.quantum.welcome) fornece uma descrição geral de alto nível da computação quântica com Q#, incluindo tutoriais para escrever o primeiro programa em Q#, guias de introdução e introdução às bibliotecas quânticas em Q# para desenvolver programas quânticos.

## <a name="learning-the-basics-what-do-you-need-to-know"></a>Conhecer as noções básicas: o que precisa de saber?

Não precisa de ter conhecimentos sobre física quântica para saber mais sobre a Q# e computação quântica ou para começar a escrever aplicações quânticas.

Estes conceitos irão proporcionar-lhe uma boa introdução aos conhecimentos fundamentais de que necessita para começar a programar programas quânticos.  
...
Agora que já conhece as noções básicas, está pronto para começar a aprender a escrever programas quânticos.  Existem várias formas de o fazer:

## <a name="do-the-quantum-katas"></a>Aprender com os Quantum Katas

Os [Quantum Katas](xref:microsoft.quantum.overview.katas) são a nossa série de tutoriais personalizados open source, destinados a ensinar-lhe elementos de computação quântica e programação em Q# ao mesmo tempo.  Cada kata faz referência a materiais de aprendizagem adicionais que pode utilizar para aprender os conceitos de computação quântica necessários para concluir os katas com êxito.  

## <a name="dive-into-the-theory"></a>Aprofundar a teoria

Talvez queira analisar a teoria da mecânica quântica e da computação mecânica mais detalhadamente. Encontra aqui uma lista de materiais úteis:
