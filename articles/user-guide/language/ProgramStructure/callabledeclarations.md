---
title: Declarações calláveis em Q#
description: Saiba como as operações e funções, ou os calcáveis, são declarados na Q# linguagem de programação.
author: bettinaheim
ms.author: beheim
ms.date: 10/07/2020
ms.topic: reference
