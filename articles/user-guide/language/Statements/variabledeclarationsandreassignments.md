---
title: Declarações variáveis e reatribuições em Q#
description: Saiba mais sobre a utilização das declarações "let" e "mutável" para ligar variáveis em Q# .
author: bettinaheim
ms.author: beheim
ms.date: 10/07/2020
ms.topic: article
