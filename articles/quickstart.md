...
#### <a name="c-command-linetabtabid-csharp"></a>[Linha de Comandos C#](#tab/tabid-csharp)
...
#### <a name="command-line--visual-studio-codetabtabid-csharp"></a>[Linha de Comandos/Visual Studio Code](#tab/tabid-csharp)
