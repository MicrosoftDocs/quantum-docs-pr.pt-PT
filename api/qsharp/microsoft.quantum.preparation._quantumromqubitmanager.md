...
title: função _QuantumROMQubitManager
...
ms.locfileid: "92724125"
---
# <a name="_quantumromqubitmanager-function"></a>função _QuantumROMQubitManager
...
## <a name="output--littleendianqubitqubit"></a>Saída :[(LittleEndian,](xref:Microsoft.Quantum.Arithmetic.LittleEndian)[Qubit](xref:microsoft.quantum.lang-ref.qubit)[]),[Qubit](xref:microsoft.quantum.lang-ref.qubit)[])
