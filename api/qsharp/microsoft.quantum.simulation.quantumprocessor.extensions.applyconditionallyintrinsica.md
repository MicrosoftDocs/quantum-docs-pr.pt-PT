...
### <a name="onequalop--unit--unit-adj"></a>onEqualOp : [Unidade](xref:microsoft.quantum.lang-ref.unit) => [Unit](xref:microsoft.quantum.lang-ref.unit) Adj




### <a name="onnonequalop--unit--unit-adj"></a>onNonEqualOp : [Unidade](xref:microsoft.quantum.lang-ref.unit) => [Adj](xref:microsoft.quantum.lang-ref.unit)
