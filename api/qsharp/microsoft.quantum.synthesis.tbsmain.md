...
---
# <a name="tbsmain-function"></a>Função TBSMain
...
Calcular máscaras de portão para sintetizar permutação.
...
## <a name="output--mcmtmask"></a>Saída : [MCMTMask](xref:Microsoft.Quantum.Synthesis.MCMTMask)[]
