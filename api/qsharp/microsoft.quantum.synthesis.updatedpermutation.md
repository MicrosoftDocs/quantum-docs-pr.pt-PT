...
title: Função de permutação atualizada
...
ms.locfileid: "92710524"
---
# <a name="updatedpermutation-function"></a>Função de permutação atualizada
...
Atualização permutação baseada em de acordo com a máscara do portão.
