...
---
# <a name="complexpolarascomplex-function"></a>Função ComplexPolarAsComplex
...
Converte um número complexo de tipos `ComplexPolar` para um número complexo de `Complex` tipos.
