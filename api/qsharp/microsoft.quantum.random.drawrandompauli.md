...
ms.locfileid: "92724643"
---
# <a name="drawrandompauli-operation"></a>Operação DrawRandomPauli
...
Desenha um valor Pauli aleatório.
...
Ou, `PauliI` `PauliX` ou com igual `PauliY` `PauliZ` probabilidade.