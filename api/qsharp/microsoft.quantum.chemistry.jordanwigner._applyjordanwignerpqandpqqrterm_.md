...
---
# <a name="_applyjordanwignerpqandpqqrterm_-operation"></a>_Aplicação Operação JordanWignerPQ ePQQRTerm_
...
Aplica a evolução temporal por um termo PQ ou PQQR descrito por um `GeneratorIndex` .
