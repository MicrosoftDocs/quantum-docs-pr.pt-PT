...
---
# <a name="_estimatederivativewithparametershift-operation"></a>operação _EstimateDerivativeWithParameterShift
...
### <a name="parameters--doubledouble"></a>parâmetros :[(Duplo](xref:microsoft.quantum.lang-ref.double)[],[Duplo](xref:microsoft.quantum.lang-ref.double)[])
