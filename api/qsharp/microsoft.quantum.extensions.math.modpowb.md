...
ms.locfileid: "96212805"
---
# <a name="modpowb-function"></a>Função ModPowB

Espaço de nome: [Microsoft.Quantum.Extensions.Math](xref:Microsoft.Quantum.Extensions.Math)

Pacote: [Microsoft.Quantum.QSharp.Core](https://nuget.org/packages/Microsoft.Quantum.QSharp.Core)


> [!WARNING]
> ModPowB foi depreciado. Por favor, use <xref:Microsoft.Quantum.Math.ModPowL> em vez disso.
>
> Utilize @"microsoft.quantum.math.modpowl".
...
### <a name="exponent--bigint"></a>expoente : [BigInt](xref:microsoft.quantum.lang-ref.bigint)
