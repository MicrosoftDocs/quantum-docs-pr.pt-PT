...
title: Tipo definido pelo utilizador de distribuição discreta
...
ms.locfileid: "96193051"
---
# <a name="discretedistribution-user-defined-type"></a>Tipo definido pelo utilizador de distribuição discreta
...
Representa uma distribuição de probabilidades univariada sobre os inteiros.
...
### <a name="sample--unit--int"></a>Amostra : [Unidade](xref:microsoft.quantum.lang-ref.unit) => [Int](xref:microsoft.quantum.lang-ref.int) 
