...
title: AplicaTargetStateReflectionOracle
...
ms.locfileid: "96191470"
---
# <a name="applytargetstatereflectionoracle-operation"></a>AplicaTargetStateReflectionOracle
...
Implementação de <xref:microsoft.quantum.canon.targetstatereflectionoracle> .
