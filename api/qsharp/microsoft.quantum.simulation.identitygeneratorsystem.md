...
---
# <a name="identitygeneratorsystem-function"></a>Função Sistema de Géneros de Identidade
...
Devolve um sistema gerador consistente com o Hamiltonian `H = 0` zero, o que corresponde à operação de evolução da identidade.
...
Um sistema gerador que representa a evolução sob o $H Hamiltonian = 0$.