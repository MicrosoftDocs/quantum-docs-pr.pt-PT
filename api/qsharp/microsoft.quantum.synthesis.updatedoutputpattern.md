...
ms.locfileid: "92724447"
---
# <a name="updatedoutputpattern-function"></a>Função DeOutputPattern atualizado
...
Atualize um padrão de saída de acordo com a máscara do portal.
...
### <a name="pattern--int"></a>padrão : [Int](xref:microsoft.quantum.lang-ref.int)
