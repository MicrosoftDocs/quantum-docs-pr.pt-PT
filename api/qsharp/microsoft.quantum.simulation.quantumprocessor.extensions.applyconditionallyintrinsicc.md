...
### <a name="onequalop--unit--unit--is-ctl"></a>onEqualOp [](xref:microsoft.quantum.lang-ref.unit) : => [Unidade](xref:microsoft.quantum.lang-ref.unit) é CTL




### <a name="onnonequalop--unit--unit--is-ctl"></a>onNonEqualOp [](xref:microsoft.quantum.lang-ref.unit) : => [Unidade](xref:microsoft.quantum.lang-ref.unit) é CTL
