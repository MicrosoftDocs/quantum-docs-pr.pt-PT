...
ms.locfileid: "92711280"
---
# <a name="expd-function"></a>Função ExpD
...
Devoluções $e$ elevado à potência especificada.
...
Consulte [System.Math.Exp](https://docs.microsoft.com/dotnet/api/system.math.exp) para mais detalhes.