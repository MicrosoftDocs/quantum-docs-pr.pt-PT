...
ms.locfileid: "92722554"
---
# <a name="_negativelocations-function"></a>função _NegativeLocations
...
### <a name="cnegative--int"></a>cNegativo : [Int](xref:microsoft.quantum.lang-ref.int)
