...
title: ExtraArithmeticAssertionsEnabled função
...
ms.locfileid: "98846653"
---
# <a name="extraarithmeticassertionsenabled-function"></a>ExtraArithmeticAssertionsEnabled função
...
Se for verdade, permite afirmações extra que são caras, mas úteis para depurar o uso das funções aritméticas.
...
Esta função permite configurar o comportamento da biblioteca.