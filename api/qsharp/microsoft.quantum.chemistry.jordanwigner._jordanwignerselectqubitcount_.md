...
ms.locfileid: "98851546"
---
# <a name="_jordanwignerselectqubitcount_-function"></a>_Função JordanWignerSelectQu5Count_
...
## <a name="output--intintintintintint"></a>Saída : ([Int](xref:microsoft.quantum.lang-ref.int)[,Int](xref:microsoft.quantum.lang-ref.int), Int ,[Int](xref:microsoft.quantum.lang-ref.int),[Int](xref:microsoft.quantum.lang-ref.int),[Int [Int])](xref:microsoft.quantum.lang-ref.int)[](xref:microsoft.quantum.lang-ref.int)
