...
> [!WARNING]
> InPlaceXorBE foi depreciado. Por favor, use <xref:ApplyReversedOpLECA(ApplyXorInPlace(value, _), target)> em vez disso.
>
...
### <a name="target--bigendian"></a>alvo : [BigEndian](xref:Microsoft.Quantum.Arithmetic.BigEndian)
