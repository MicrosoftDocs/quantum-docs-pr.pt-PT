...
---
# <a name="applyconditionallyintrinsic-operation"></a>Aplicar operação Contraditionalintes
...
### <a name="onequalop--unit--unit"></a>onEqualOp [Unit](xref:microsoft.quantum.lang-ref.unit) : => [Unidade](xref:microsoft.quantum.lang-ref.unit) 




### <a name="onnonequalop--unit--unit"></a>onNonEqualOp : [Unidade de](xref:microsoft.quantum.lang-ref.unit) => [Unidade](xref:microsoft.quantum.lang-ref.unit) 
