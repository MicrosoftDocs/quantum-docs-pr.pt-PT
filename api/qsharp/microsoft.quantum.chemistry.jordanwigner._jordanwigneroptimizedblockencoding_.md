...
ms.locfileid: "96215695"
---
# <a name="_jordanwigneroptimizedblockencoding_-function"></a>_Função JordanWignerOptimizedBlockEncoding_
...
## <a name="output--intintdoubleblockencodingreflection"></a>Saída :[(Int](xref:microsoft.quantum.lang-ref.int),[Int](xref:microsoft.quantum.lang-ref.int)[(Double](xref:microsoft.quantum.lang-ref.double),[BlockEncodingReflection))](xref:Microsoft.Quantum.Simulation.BlockEncodingReflection)
