...
title: operação _ApplyTwoQubitCase
...
ms.locfileid: "98847142"
---
# <a name="_applytwoqubitcase-operation"></a>operação _ApplyTwoQubitCase
...
### <a name="datum--double"></a>datum : [Duplo](xref:microsoft.quantum.lang-ref.double)[]
