...
Devolve o bitwise OR de dois inteiros.
...
Ver o [C# | Telefonista](https://docs.microsoft.com/dotnet/csharp/language-reference/operators/or-operator) para mais detalhes.