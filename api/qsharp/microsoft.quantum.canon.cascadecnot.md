...
---
# <a name="cascadecnot-operation"></a>Operação CascadeCNOT
...
> [!WARNING]
> CascadeCNOT foi depreciada. Por favor, use <xref:Microsoft.Quantum.Canon.ApplyCNOTChain> em vez disso.
>
> Utilize @"microsoft.quantum.canon.applycnotchain".
