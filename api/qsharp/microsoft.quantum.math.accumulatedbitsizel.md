...
title: Função De BitsizeL acumulado
...
ms.locfileid: "98847677"
---
# <a name="accumulatedbitsizel-function"></a>Função De BitsizeL acumulado
...
Função do ajudante usada para calcular recursivamente o bitsize de um valor.
