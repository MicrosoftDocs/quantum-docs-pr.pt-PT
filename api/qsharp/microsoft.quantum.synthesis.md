...
ms.locfileid: "98855354"
---
# <a name="microsoftquantumsynthesis-namespace"></a>Microsoft.Quantum.Synthesis namespace

Este espaço de nome contém funções e operações para sintetizar operações quânticas baseadas em permutações e funções booleanas.
