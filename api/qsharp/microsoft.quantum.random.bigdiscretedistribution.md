...
title: Tipo definido por bigDiscriteDistribution
...
ms.locfileid: "98855799"
---
# <a name="bigdiscretedistribution-user-defined-type"></a>Tipo definido por bigDiscriteDistribution
...
Representa uma distribuição de probabilidade univariada sobre inteiros de tamanho arbitrário.
...
### <a name="sample--unit--bigint"></a>Amostra : [Unidade](xref:microsoft.quantum.lang-ref.unit) => [BigInt](xref:microsoft.quantum.lang-ref.bigint) 
