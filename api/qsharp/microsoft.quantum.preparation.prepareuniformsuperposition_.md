...
title: operação PrepareUniformSuperposition_
...
ms.locfileid: "92723002"
---
# <a name="prepareuniformsuperposition_-operation"></a>operação PrepareUniformSuperposition_
...
Passo de implementação <xref:microsoft.quantum.canon.prepareuniformsuperposition>
