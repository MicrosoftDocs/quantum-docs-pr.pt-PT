...
---
# <a name="microsoftquantumbitwise-namespace"></a>Microsoft.Quantum.Bitwise namespace

Este espaço de nome contém funções para agir sobre a representação bitwise de tipos de dados clássicos.
