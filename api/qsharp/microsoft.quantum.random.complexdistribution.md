...
title: Tipo definido pelo utilizador ComplexDistribution
...
ms.locfileid: "98857830"
---
# <a name="complexdistribution-user-defined-type"></a>Tipo definido pelo utilizador ComplexDistribution
...
Representa uma distribuição de probabilidades univariada sobre números complexos.
...
### <a name="sample--unit--complex"></a>Amostra : [Complexo de](xref:microsoft.quantum.lang-ref.unit) => [Unidades](xref:Microsoft.Quantum.Math.Complex) 
