...
ms.locfileid: "92724965"
---
# <a name="applydeterministicstateoraclefromstateoracle-operation"></a>AplicaçãoDeterminísticaStateOracleFromStateOracle operação
...
Implementação de <xref:microsoft.quantum.canon.deterministicstateoraclefromstateoracle> .
