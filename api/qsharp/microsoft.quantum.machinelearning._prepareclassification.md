...
---
# <a name="_prepareclassification-operation"></a>operação _PrepareClassification
...
### <a name="encoder--littleendian--unit--is-adj--ctl"></a>codificação : [Unidade LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian) => [Unit](xref:microsoft.quantum.lang-ref.unit) é Adj + Ctl
