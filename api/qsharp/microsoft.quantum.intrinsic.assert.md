...
ms.locfileid: "98819733"
---
# <a name="assert-operation"></a>Operação de afirmação
...
> [!WARNING]
> A afirmação foi depreciada. Por favor, use <xref:Microsoft.Quantum.Diagnostics.AssertMeasurement> em vez disso.
