...
ms.locfileid: "96200276"
---
# <a name="syndrome-user-defined-type"></a>Tipo definido pelo utilizador da síndrome
...
Digite os resultados de medição `Result[]` que especifiquem uma síndrome de erro de um código quântico.
