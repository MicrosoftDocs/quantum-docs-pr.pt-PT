...
title: Tipo definido pelo utilizador de distribuição contínua
...
ms.locfileid: "98842337"
---
# <a name="continuousdistribution-user-defined-type"></a>Tipo definido pelo utilizador de distribuição contínua
...
Representa uma distribuição de probabilidades univariada sobre números reais.
...
### <a name="sample--unit--double"></a>Amostra : [Unidade](xref:microsoft.quantum.lang-ref.unit) => [Dupla](xref:microsoft.quantum.lang-ref.double) 
